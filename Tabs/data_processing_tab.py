...
class DataProcessingTab:
    ...
    def toggle_debug_mode(self):
        ...
        # Update MLRobotUtils debug mode state
        self.utils.is_debug_mode = self.is_debug_mode
    ...
    def process_data(self):
        ...
        try:
            ...
            self.utils.log_message(f"Processed data saved to '{save_path}'.", self.parent, self.log_message)
